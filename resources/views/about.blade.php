...
<div
      ...
      style="background-image: url({{asset('asset/images/hero_bg_3.jpg')}})"
    >
      <div class="container">
      ...
      <div class="container">
        <div class="row justify-content-between mb-5">
          <div class="col-lg-7 mb-5 mb-lg-0">
            <div class="img-about dots">
              <img src="{{url('/')}}/asset/images/hero_bg_2.jpg" alt="Image" class="img-fluid" />
            </div>
          </div>
          <div class="col-lg-4">
            <div class="d-flex feature-h">
          ...
          <div class="testimonial-slider">
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{url('/')}}/asset/images/person_1-min.jpg"
                  alt="Image"
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{url('/')}}/asset/images/person_2-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{url('/')}}/asset/images/person_3-min.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="{{url('/')}}/asset/images/person_4.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
